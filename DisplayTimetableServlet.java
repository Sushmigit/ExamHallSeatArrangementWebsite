...
@WebServlet("/DisplayTimetableServlet")
public class DisplayTimetableServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT * FROM timetable WHERE TRIM(department) = ? AND TRIM(semester) = ? ";
        ...
        RequestDispatcher rd = request.getRequestDispatcher("displayTimetable.jsp");
