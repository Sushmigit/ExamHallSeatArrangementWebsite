...
@WebServlet("/DisplayUnallocatedTT")
public class DisplayUnallocatedTT extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT exam_name, subject_name, exam_date, session FROM timetable " +
                    "WHERE department = ? AND semester = ? AND allocated = 0";
        ...
        request.setAttribute("examList", unallocatedList);
